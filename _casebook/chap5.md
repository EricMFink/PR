...
<p class="case-h1">Confidentiality of Information</p>
...
<p class="case-h1">Duties to Former Clients</p>
...
<p class="case-h1">Respect for Rights of Third Persons</p>
...
<p class="case-h1">Information About a Possible Wrongful Conviction</p>
...
<p class="case-h1">Justice Beth Baker delivered the Opinion and Order of the Court.</p>
...
<p class="case-h1">Francis E. Sweeny, Sr., J.</p>
...
<p class="case-h1">PFEIFER, J., concurring in part and dissenting in part.</p>
...
<p class="case-h1">William W. Fletcher, Circuit Judge</p>
...
<p class="case-h2">A. Offense, Arrest and Conviction</p>
...
<p class="case-h2">B. Disclosure of the Children's Whereabouts</p>
...
<p class="case-h2">A. The Duty of Confidentiality</p>
...
<p class="case-h1">Attorney-Client Privilege</p>
...
<p class="case-h1">Attorney-Client Privilege—"Communication"</p>
...
<p class="case-h1">Attorney-Client Privilege—"Privileged Persons"</p>
...
<p class="case-h1">Attorney-Client Privilege—"In Confidence"</p>
...
<p class="case-h1">Attorney-Client Privilege—Legal Assistance as the Object of a Privileged Communication</p>
...
<p class="case-h1">The Privilege of Co-Clients</p>
...
<p class="case-h1">The Privilege in Common-Interest Arrangements</p>
...
<p class="case-h1">Duration of the Privilege</p>
...
<p class="case-h1">Invoking the Privilege and Its Exceptions</p>
...
<p class="case-h1">Terry, Associate Judge</p>
...
<p class="case-h1">Ormand N. Gale, J.</p>
...
<p class="case-h1">ZIMMERMAN, Justice (dissenting).</p>
...
<p class="case-h1">Ellis, District Judge</p>
...
<p class="case-h1">Lawyer Work-Product Immunity</p>
...
<p class="case-h1">Ordinary Work Product</p>
...
<p class="case-h1">Opinion Work Product</p>
...
<p class="case-h1">Invoking the Lawyer Work-Product Immunity and Its Exceptions</p>
...
<p class="case-h1">Duty to Disclose; General Provisions Governing Discovery</p>
...
<p class="case-h1">JAMES HUNTER, III, Circuit Judge.</p>
...
<p class="case-h1">SEITZ, Circuit Judge, dissenting.</p>
...
<p class="case-h1">SENTELLE, Chief Judge</p>
...
<p class="case-h2">A. The Work-Product Doctrine</p>
...
<p class="case-h2">B. The Deloitte Memorandum</p>
...
<p class="case-h2">C. The Dow Documents</p>
...
<p class="case-h1">The Privilege for an Organizational Client</p>
...
<p class="case-h1">The Privilege for a Governmental Client</p>
...
<p class="case-h1">SEITZ, Circuit Judge.</p>
...
<p class="case-h1">GINSBURG, Chief Judge</p>
...
<p class="case-h1">Agreement, Disclaimer, or Failure to Object</p>
...
<p class="case-h1">Subsequent Disclosure</p>
...
<p class="case-h1">Putting Assistance or a Communication in Issue</p>
...
<p class="case-h1">A Dispute Concerning a Decedent's Disposition of Property</p>
...
<p class="case-h1">Client Crime or Fraud</p>
...
<p class="case-h1">Lawyer Self-Protection</p>
...
<p class="case-h1">Fiduciary-Lawyer Communications</p>
...
<p class="case-h1">Communications Involving a Fiduciary Within an Organization</p>
...
<p class="case-h1">Voluntary Acts</p>
...
<p class="case-h1">Use of Lawyer Work Product in Litigation</p>
...
<p class="case-h1">Attorney-Client Privilege and Work Product; Limitations on Waiver</p>
...
<p class="case-h1">SILBERMAN, Circuit Judge:</p>
...
Although these cases seem to conflate two theories---waiver of an existing privilege and absence of an intent to maintain confidentiality in the first place---we think under either theory the IRS cases are inapposite; the government much too facilely claims that the six documents are merely "details" underlying past or future returns. To be sure, virtually all the material in the documents reflects adjusting entries in Company's books, which have been or will be reported to the IRS.[^53b6] But the crucial significance of the documents---and the apparent reason the government wishes to present them to the grand jury---is that they suggest Company made the adjusting entries on the advice of counsel (after the investigation commenced).


[^53b6]: (n.4 in opinion) If the information has not yet been disclosed, it is hard to think of Company's action as a waiver. Rather, data that Company intends to report is never privileged in the first place.
...
<p class="case-h1">MR. JUSTICE CARDOZO delivered the opinion of the Court.</p>
...
<p class="case-h1">JUSTICE BLACKMUN delivered the opinion of the Court.</p>
...
<p class="case-h1">WALD, Circuit Judge</p>
...
<p class="case-h3">DOCUMENT 19 AND THE WORK PRODUCT EXEMPTION</p>
...
<p class="case-h1">SPENCER, District Judge.</p>
