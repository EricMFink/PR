...
Yes. See Rule 2.1 ("In rendering advice, a lawyer may refer not only to law but to other considerations such as moral, economic, social and political factors, that may be relevant to the client’s situation.")
:::
...
Lawyer may prepare the opinion letter, "if the lawyer reasonably believes that making the evaluation is compatible with other aspects of the lawyer's relations with the client." Rule 2.2 (a). If Lawyer believes that the evaluation "is likely to affect the client's interests materially and adversely", Lawyer must obtain the client's informed consent, which would include advising the client about potential liability or other adverse consequences. Rule 2.2(b)
:::
...
Answer (c) is correct. Anderson and Peterson are each liable for malpractice based on their own failures to exercise reasonable care. Paulson is liable for malpractice as a partner in the firm.  
:::
